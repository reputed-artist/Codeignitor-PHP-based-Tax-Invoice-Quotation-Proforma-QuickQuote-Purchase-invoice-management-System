...
{
    protected $table = 'techsps'; // Specify your table name
    protected $primaryKey = 'tid'; // Specify your primary key column

    

    protected $allowedFields = ['p_id', 'img_loc','techs','subcat']; // Specify allowed fields
