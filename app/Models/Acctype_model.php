...
class Acctype_model extends Model
{
    protected $table = 'acc_type'; // Specify your table name
    protected $primaryKey = 'id'; // Specify your primary key column

    protected $allowedFields = ['id', 'type']; // Specify allowed fields
    ...
    public function getAccountTypeDetails()
    {
        return $this->select('*')
                    ->findAll();
    }
