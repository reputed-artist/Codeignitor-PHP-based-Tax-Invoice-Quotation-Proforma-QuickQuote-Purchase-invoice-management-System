                      ...
                      <div class="box">
                        <div class="box-body">                                                 
                               <table id="example" class="table table-bordered table-striped">
                                     ...
                                     <tbody>                                                                     
                                      ...
                                      <tr>
                                            ...
                                            <td><h3 id="baseamt">0.00</h3></td> 
                                           
                                            <td><h3 id="quantity">0.00</h3></td>
                                            <td><h3 id="subtotal">0.00</h3></td>
                                            <td></td>
                                            <td><h3 id="taxamt">0.00</h3><h3></h3></td>
                          ...
                          <input type="button" class="toggle-vis btn btn-primary" data-column="1" value="Inv Date">
                                    ...
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="3" value="Description">
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="4" value="HSN">
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="5" value="Base Amt">
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="6" value="Quantity">
                                    
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="7" value="Subtotal">
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="8" value="Tax %">
                                    <input type="button" class="toggle-vis btn btn-primary" data-column="9" value="Tax Amt">
                                   <input type="button" class="toggle-vis btn btn-primary" data-column="10" value="Total Amt">
                                    </br> 
                                  </div>  
                         </div>
                       </div>
