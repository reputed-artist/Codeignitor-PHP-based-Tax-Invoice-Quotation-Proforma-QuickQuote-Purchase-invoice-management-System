    ...
    <a href="#">
        ...
        <li class="<?= set_active('/product/manageproducts'); ?>">
          <a href="<?= base_url('/product/manageproducts'); ?>">
            <i class="fa fa-fw fa-cube"></i> <span>Products</span>
            <span class="pull-right-container">
              <small class="label pull-right bg-green">new</small>
            </span>
          </a>
 ...
 -->
          ...
          <a href="<?=base_url('/quickquote/')?>">
            <i class="fa fa-fw fa-bolt"></i><span> Quick Quotation</span>
         ...
         <li class="<?= set_active('/quote/genquote') ?>">
          <a href="<?=base_url('/quote/genquote')?>">
            <i class="fa fa-fw fa-file-text-o"></i> <span>Gen. Quotation</span>
         ...
         <li class="<?= set_active('/quote/showquotedata') ?>">
          <a href="<?=base_url('/quote/showquotedata')?>">
            <i class="fa fa-fw fa-list-alt"></i><span> Quotation List</span>
...
<li class="treeview <?= set_active('proinv/showprodata') || set_active('taxinv/showtaxdata') ? 'active' : '' ?>">
    ...
    <ul class="treeview-menu">
        <li class="<?= set_active('proinv/showprodata') ?>"><a href="<?= base_url('/proinv/showprodata') ?>"><i class="fa fa-fw fa-floppy-o"></i> Proforma Invoice List</a></li>
        <li class="<?= set_active('taxinv/showtaxdata') ?>"><a href="<?= base_url('/taxinv/showtaxdata') ?>"><i class="fa fa-fw fa-barcode"></i> Tax Invoice List</a></li>
    </ul>
</li>
...
<li class="treeview <?= set_active('proinv/genproinv') || set_active('taxinv/gentaxinv') ? 'active' : '' ?>">
    ...
    <ul class="treeview-menu" style="display: block;">
        <li class="<?= set_active('proinv/genproinv') ?>"><a href="<?= base_url('/proinv/genproinv') ?>"><i class="fa fa-fw fa-floppy-o"></i> Gen. Proforma Invoice </a></li>
        <li class="<?= set_active('taxinv/gentaxinv') ?>"><a href="<?= base_url('/taxinv/gentaxinv') ?>"><i class="fa fa-fw fa-barcode"></i> Gen. Tax Invoice</a></li>
    </ul>
</li>
