$(document).ready(function() {
    ...
    $(document).on('click', '.add', function() {
        ...
        html +='<td><select name="item_name[]" id="productName_' + count + '" class="form-control select2 item_unit" onchange="showHsn(' + count + ', this.value)" required="required" style="width:100% !important;"><option value="">Select Item</option></select></td>';
